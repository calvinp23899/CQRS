...
namespace Ecommerce.API.Controllers
{
    ...
    public class OrdersController : CustomBaseController
    {
        ...
        public async Task<IActionResult> DownloadOrderBillDetail([Required] int id)
        {
            var result = await _mediator.Send(new DownloadOrderDetailQuery { Id = id });
        ...
        private MemoryStream ExportTimecardDailyDetail()
        {
